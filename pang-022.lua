...
local pang_version="022" -- versione
...
word_definitions["list_word_definitions"]={0,list_word_definitions_function}
...
function read_execute_loop()
  while true do
    ...
    if program==nil or program=="exit" then break end
    execute_program(program)
  end
end
...
-- check also single-word and empty string and consecutive strings

test_string=[[

print string " hello world "
print string " multiline line1
line2
line3 "
print string " "
execute
print string " after execute "
