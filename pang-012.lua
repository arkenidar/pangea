...
local pang_version="012" -- versione
local language="italian" -- lingua
...
execute_program("definisci_parola quadrato 1 moltiplica argomento 1 argomento 1")
--execute_program("print square 4") --> 16
execute_program("stampa quadrato 4") --> 16
