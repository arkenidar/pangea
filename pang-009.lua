...
local pang_version="009" -- was 007
...
function define_word_function(arguments)
  ...
  local word_function=function(word_arguments)
    local returned
    --print(evaluate_word(word_arguments[1]),"first argument")
    table.insert(call_stack,word_arguments)
...
function argument_function(arguments)
  return evaluate_word(call_stack[#call_stack][evaluate_word(arguments[1])])
end
...
---execute_program("define_word string square 1 multiply argument 1 argument 1") -- TODO with argument access
---execute_program("print square 4")
--- print(phrase_length(2).."#")

-- add factorial operator test for recursion
execute_program("define_word string factorial 1 equal 0 argument 1")
--execute_program("define_word string factorial 1 if equal 0 argument 1 11 2") -- equal 0 argument -> false (equal/3 is wrong equal/4 should be instead... and if/7)

-- if equal 0 argument 1 11 2
-- multiply argument 1 factorial add -1 argument 1
execute_program("print factorial 0")
execute_program("print factorial 4")
